class Solution {
public:
    //use segment tree whenever there is question of range queries and where you need updation
    ...
    long long goodTriplets(vector<int>& nums1, vector<int>& nums2) {
        ...
        //marking the nums2 index in map
        for (int i = 0; i < n; i++) {
            mp[nums2[i]] = i;
        }
        ...
        for (int i = 1; i < n; i++) {
            ...
            //updating after getting the result
